...
myurl1 = URLs["boundData"]
myurl2 = URLs["unboundData"]

saveurl1 = URLs["boundGK"]
saveurl2 = URLs["unboundGK"]

boundGKidURL = URLs["results"] + "gatekeepersBound.csv"
unboundGKidURL = URLs["results"] + "gatekeepersUnbound.csv"
